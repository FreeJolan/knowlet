...
const I = {
  ...
  AI: (p) => <Icon {...p}><path d="M12 3v3M12 18v3M3 12h3M18 12h3M5.6 5.6l2.1 2.1M16.3 16.3l2.1 2.1M5.6 18.4l2.1-2.1M16.3 7.7l2.1-2.1" /><circle cx="12" cy="12" r="3" /></Icon>,
  Graph: (p) => <Icon {...p}><circle cx="6" cy="6" r="2.5" /><circle cx="18" cy="7" r="2.5" /><circle cx="12" cy="17" r="2.5" /><circle cx="5" cy="18" r="1.5" /><path d="M8 7h8M7.5 8 11 15M16.5 9 13 15M11 17 6.5 17.5" /></Icon>,
  Pin: (p) => <Icon {...p}><path d="M12 2v6l4 2v3H8v-3l4-2V2zM12 13v9" /></Icon>,
  Lasso: (p) => <Icon {...p}><path d="M5 7c0-2 3-4 7-4s7 2 7 4-3 4-7 4-7-2-7-4z" /><path d="M5 7c0 4 1 8 2 9M19 7c0 1-.5 2-1 3M9 21c-2-.5-3-2-2-4" /></Icon>,
