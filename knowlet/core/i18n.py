...
_EN: dict[str, str] = {
    ...
    "web.clear": "clear",
    "web.save": "save",
    "web.save.drafting": "drafting…",
    "web.cancel": "cancel",
    "web.composer.placeholder": "Ask, discuss, or paste — Enter to send, Shift+Enter for newline.",
    "web.composer.expand": "fullscreen",
    "web.editor.title": "fullscreen editor",
    "web.editor.split_on": "split preview",
    "web.editor.split_off": "single column",
    "web.editor.hint": "⌘⏎ send · Esc close",
...
_ZH: dict[str, str] = {
    ...
    "web.clear": "清空",
    "web.save": "保存",
    "web.save.drafting": "起草中…",
    "web.cancel": "取消",
    "web.composer.placeholder": "提问、讨论、粘贴 —— Enter 发送,Shift+Enter 换行。",
    "web.composer.expand": "全屏",
    "web.editor.title": "全屏编辑器",
    "web.editor.split_on": "双栏预览",
    "web.editor.split_off": "单栏",
    "web.editor.hint": "⌘⏎ 发送 · Esc 关闭",
