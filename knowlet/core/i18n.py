...
_EN: dict[str, str] = {
    ...
    "header.palette.title": "Command palette (coming in M6.2)",
    "header.palette.toast": "Command palette ships in M6.2 — coming soon.",
...
_ZH: dict[str, str] = {
    ...
    "header.palette.title": "命令面板(M6.2 上线)",
    "header.palette.toast": "命令面板下个版本就来,先用底栏入口。",
