...
_EN: dict[str, str] = {
    ...
    "config.embed.backend.prompt": "backend (dummy/sentence_transformers)",
    ...
    "palette.cmd.reindex": "Rebuild index",
    "palette.cmd.reindex.sub": "knowlet reindex — rescan notes/ from disk",
    "palette.cmd.reindex.running": "Reindex running…",
    "palette.cmd.reindex.done": "Reindex done · {changed} updated, {deleted} removed, {unchanged} unchanged",
    "palette.cmd.doctor": "Doctor",
    "palette.cmd.doctor.sub": "knowlet doctor — check vault, LLM, embeddings",
    "palette.cmd.doctor.running": "Doctor running…",
    "palette.cmd.doctor.done": "Doctor: {fail} failure(s), {warn} warning(s)",
    # Sidebar (vault tree)
    ...
    "select.attach_to_chat": "Quote in chat",
    "chat.reference.reuse": "Reuse",
    "chat.url.fetch": "Fetch & discuss",
    "chat.url.fetching": "Fetching… summarizing…",
    "chat.url.error": "Fetch failed",
    "palette.cmd.urlcapture": "Capture URL",
    "palette.cmd.urlcapture.sub": "Fetch a webpage, summarize, attach as a chat capsule",
    "palette.cmd.urlcapture.prompt": "Enter the URL to capture",
    "palette.cmd.websearch": "Web search",
    "palette.cmd.websearch.sub": "Search the live web (UI peer of the web_search LLM tool — ADR-0004 amendment)",
    "palette.cmd.websearch.prompt": "Search what?",
    "palette.cmd.newcard": "New Card",
    "palette.cmd.newcard.sub": "Create a card by hand (UI peer of the create_card LLM tool — ADR-0004 amendment)",
    "review.create_new": "+ New Card",
    "card.new.title": "New Card",
    "card.new.intro": "Front + back is one atomic fact card. FSRS will schedule reviews on your memory curve.",
    "card.new.front": "Front (question)",
    "card.new.back": "Back (answer)",
    "card.new.tags": "Tags (comma-separated)",
    "card.new.cancel": "Cancel",
    "card.new.commit": "Create",
    "card.new.empty": "front and back are both required",
    "card.new.created": "Card created",
    "palette.cmd.quiz": "Quiz me",
    ...
    "quiz.scope.tag": "Scope · tag",
    "quiz.scope.tag.empty": "No tags yet. Add tags to a note's frontmatter first.",
    "quiz.scope.tag_empty": "Pick a tag",
    "quiz.scope.heading": "Pick the scope",
    "quiz.scope.intro": "Select 1-N notes as quiz sources. The AI generates active-recall questions (not 'find the answer' style), with reference answers and advisory grading. The grading is informational — you can disagree.",
    "quiz.scope.notes": "Scope · Notes",
    "quiz.scope.advanced": "Advanced settings",
    "quiz.scope.n_questions": "Questions",
    "quiz.scope.n_default": "default 5, range 1-20",
    "quiz.scope.start": "Start",
    "quiz.scope.cancel": "Cancel",
    "quiz.scope.empty": "Pick at least one note",
    "quiz.generating": "Generating questions…",
    "quiz.error.heading": "Generation failed",
    "quiz.error.retry": "Retry",
    "quiz.error.back": "Back",
    "quiz.answer.placeholder": "Answer in your own words… (empty = skip)",
    "quiz.answer.submit": "Submit",
    "quiz.answer.kbd": "⌘⏎ submit",
    "quiz.your_answer": "Your answer",
    "quiz.reference": "Reference answer",
    "quiz.missing": "missing:",
    "quiz.next": "Next question",
    "quiz.finish": "Finish",
    "quiz.summary.session_score": "Session score",
    "quiz.summary.review": "Per-question review",
    "quiz.summary.your_answer": "you:",
    "quiz.summary.reference": "ref:",
    "quiz.summary.disagree": "✗ I disagree",
    "quiz.summary.you_disagreed": "You marked disagreement",
    "quiz.summary.disagree_reason": "Why disagree? (optional)",
    "quiz.summary.disagree_confirm": "Confirm",
    "quiz.summary.disagree_cancel": "Cancel",
    "quiz.summary.reflux_into_card": "Make into Card",
    "quiz.summary.reflux_done": "✓ Card created",
    "quiz.summary.reflux_batch": "Batch create Cards",
    "quiz.summary.done": "Done",
    ...
    "chat.session.sidebar.title": "Sessions",
    "chat.session.untitled": "(untitled)",
    "chat.session.new.label": "New chat",
    "chat.session.new.title": "Start a fresh conversation",
    "chat.session.empty": "No past sessions yet. Send a message and one will appear here.",
    "chat.session.rename.title": "Rename session",
    "chat.session.rename.prompt": "New title:",
    "chat.session.delete.title": "Delete session",
    "chat.session.delete.confirm": "Delete this session? This can't be undone.",
    "chat.session.delete.refuse_active": "Switch to another session first, then delete.",
...
_ZH: dict[str, str] = {
    ...
    "palette.cmd.newnote.sub": "knowlet notes new",
    "palette.cmd.reindex": "重建索引",
    "palette.cmd.reindex.sub": "knowlet reindex — 从盘上重扫 notes/",
    "palette.cmd.reindex.running": "正在重建索引…",
    "palette.cmd.reindex.done": "索引已重建 · 更新 {changed} 条 / 删除 {deleted} 条 / 未变 {unchanged} 条",
    "palette.cmd.doctor": "系统检查",
    "palette.cmd.doctor.sub": "knowlet doctor — 检查 vault / LLM / embedding",
    "palette.cmd.doctor.running": "正在自检…",
    "palette.cmd.doctor.done": "自检完成 · {fail} 个失败 / {warn} 个警告",
    # Sidebar(笔记树)
    ...
    "select.attach_to_chat": "引用至聊天",
    "chat.reference.reuse": "再用",
    "chat.url.fetch": "抓取并讨论",
    "chat.url.fetching": "抓取中…摘要中…",
    "chat.url.error": "抓取失败",
    "palette.cmd.urlcapture": "抓取网页",
    "palette.cmd.urlcapture.sub": "抓取网页 → 摘要 → 作为聊天胶囊",
    "palette.cmd.urlcapture.prompt": "请输入要抓取的 URL",
    "palette.cmd.websearch": "网页搜索",
    "palette.cmd.websearch.sub": "搜索实时网页(对应 web_search LLM 工具的 UI 入口 — ADR-0004 修订)",
    "palette.cmd.websearch.prompt": "搜索什么?",
    "palette.cmd.newcard": "新建 Card",
    "palette.cmd.newcard.sub": "手动创建 Card(对应 create_card LLM 工具的 UI 入口 — ADR-0004 修订)",
    "review.create_new": "+ 新建 Card",
    "card.new.title": "新建 Card",
    "card.new.intro": "前 + 背面是一张原子事实卡。FSRS 会按你的记忆曲线安排复习。",
    "card.new.front": "正面(问题)",
    "card.new.back": "背面(答案)",
    "card.new.tags": "标签(逗号分隔)",
    "card.new.cancel": "取消",
    "card.new.commit": "创建",
    "card.new.empty": "正面 + 背面都不能为空",
    "card.new.created": "Card 已创建",
    "palette.cmd.quiz": "考我",
    "palette.cmd.quiz.sub": "用主动召回 quiz 检验对笔记的理解(Cmd+Shift+Q)",
    "sediment.similar.heading": "可能相关的笔记",
    "sediment.similar.loading": "载入中…",
    "sediment.similar.disclaimer": "纯供参考。默认动作仍然是「保存为新笔记」。",
    "quiz.title": "考我",
    "quiz.tab.new": "新 quiz",
    "quiz.tab.history": "历史",
    "quiz.history.heading": "过往 quiz",
    "quiz.history.intro": "点一行打开当时的 summary。90 天后没产生 Card 的会话会自动归档(产生 Card 的留长)。",
    "quiz.history.loading": "载入中…",
    "quiz.history.empty": "还没有 quiz 历史。回到「新 quiz」开一个。",
    "quiz.scope.kind": "范围方式",
    "quiz.scope.kind.notes": "手选笔记",
    "quiz.scope.kind.tag": "按 tag",
    "quiz.scope.tag": "范围 · 标签",
    "quiz.scope.tag.empty": "还没有任何 tag。先在笔记 frontmatter 加几个 tag 再来。",
    "quiz.scope.tag_empty": "请选一个 tag",
    "quiz.scope.heading": "挑选 scope",
    "quiz.scope.intro": "选 1-N 条笔记作为考题来源。AI 会出 N 道主动召回题(不是「找答案」题),并给参考答案 + advisory 评分。评分仅供参考,你可以不同意。",
    "quiz.scope.notes": "范围 · 笔记",
    "quiz.scope.advanced": "高级设置",
    "quiz.scope.n_questions": "出题数",
    "quiz.scope.n_default": "默认 5,1-20 之间",
    "quiz.scope.start": "开始",
    "quiz.scope.cancel": "取消",
    "quiz.scope.empty": "请至少选一条笔记",
    "quiz.generating": "出题中…",
    "quiz.error.heading": "出题失败",
    "quiz.error.retry": "重试",
    "quiz.error.back": "返回",
    "quiz.answer.placeholder": "用你自己的话回答…(留空 = 跳过)",
    "quiz.answer.submit": "提交",
    "quiz.answer.kbd": "⌘⏎ 提交",
    "quiz.your_answer": "你的回答",
    "quiz.reference": "参考答案",
    "quiz.missing": "缺漏:",
    "quiz.next": "下一题",
    "quiz.finish": "完成",
    "quiz.summary.session_score": "本次成绩",
    "quiz.summary.review": "逐题回顾",
    "quiz.summary.your_answer": "你答:",
    "quiz.summary.reference": "参考:",
    "quiz.summary.disagree": "✗ 我不同意",
    "quiz.summary.you_disagreed": "你已标记不同意",
    "quiz.summary.disagree_reason": "为什么不同意?(可空)",
    "quiz.summary.disagree_confirm": "确认",
    "quiz.summary.disagree_cancel": "取消",
    "quiz.summary.reflux_into_card": "做成 Card",
    "quiz.summary.reflux_done": "✓ 已做成 Card",
    "quiz.summary.reflux_batch": "批量做成 Card",
    "quiz.summary.done": "完成",
    ...
    # Chat focus mode
    "chat.focus.title": "对话",
    "chat.session.sidebar.title": "会话",
    "chat.session.untitled": "(未命名)",
    "chat.session.new.label": "新会话",
    "chat.session.new.title": "开一段新对话",
    "chat.session.empty": "还没有历史会话。发条消息后会出现在这里。",
    "chat.session.rename.title": "重命名会话",
    "chat.session.rename.prompt": "新标题:",
    "chat.session.delete.title": "删除会话",
    "chat.session.delete.confirm": "确定删除这段会话?这一步不可撤销。",
    "chat.session.delete.refuse_active": "先切到别的会话,再删除当前这条。",
    # 把对话存成笔记(web flow)
